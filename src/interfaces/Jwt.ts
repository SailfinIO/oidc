 ...
 *
 * The `Jwt` interface encapsulates the entire structure of a JWT, providing
 * access to its header, payload, and signature components. This interface
 * facilitates the parsing and validation of JWTs within the application.
 *
 * @interface Jwt
 */
...
/**
 * Represents the raw segments of a JWT before decoding.
 *
 * The `JwtSegments` interface defines the structure of the JWT segments
 * as strings, typically before they are decoded into their respective
 * header and payload objects.
 *
